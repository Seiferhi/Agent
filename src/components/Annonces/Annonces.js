...
import Editable from './tableAnnonce/tableAnnonce';
      ...
      <div className="Annonces">
        ...
        <div className="container-fluid">
          ...
          <div className="row page-titles">
            ...
            <Link  to="/ajouterAnnonce" ><button type="button" className="btn btn-info"><i className="fa fa-plus-circle" /> Ajouter  Une Annonce</button></Link>
            </div>
            <div className>
